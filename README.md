...
Перевод официальной документации RequireJS на русский язык.

## Процесс перевода

В папке `docs-ru/` хранятся переведённые страницы. В процессе сборки сайта они перекрывают страницы без перевода. Если у вас появилось непреодолимое желание помочь с переводом, вам необходимо просто скопировать нужную страницу из папки `docs/` в `docs-ru/`, перевести и сделать пулл-руквест. Мир скажет вам спасибо!
